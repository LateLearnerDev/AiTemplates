...
{
    /// <inheritdoc />
    public partial class SeedingFirstBatchOfData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "FirstName", "LastName", "LoginId" },
                values: new object[,]
                {
                    { 1, "John", "Doe", null },
                    { 2, "Jane", "Smith", null }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 10, 17, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(1055), 4, "Strength Training Cycle", new DateTime(2024, 9, 19, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(993), 1 },
                    { 2, null, 6, "Hypertrophy Cycle", new DateTime(2024, 10, 5, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(1059), 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 3, null, new DateTime(2024, 10, 9, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(1081), 2 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 9, 29, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(1076), 1 },
                    { 2, 1, new DateTime(2024, 10, 1, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(1079), 1 },
                    { 4, 2, new DateTime(2024, 10, 12, 15, 17, 0, 40, DateTimeKind.Utc).AddTicks(1084), 2 }
                });
