...
namespace Infrastructure.Clients.Models.OpenAi.Completion;
...
public class Choice
{
    ...
    public object? Logprobs { get; set; } // You could create a proper type for this if you have the structure
